...
public class ChoucairAcademyStepDefinitions {
    ...
    @Given("^than ferney wants to learn automation at the academy choucair$")
    public void thanFerneyWantsToLearnAutomationTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData)
            throws Exception{
        OnStage.theActorCalled("Ferney").wasAbleTo(OpenUp.thePage(), Login.onThePage(
